...
if __name__ == "__main__":
    ...
    print(analyze_finances("¿Cuanto ha sido los ingresos durante el año?"))
    print(analyze_finances("¿Cual es el total de ingresos de agosto"))
    print(analyze_finances("¿Cual es el total de gastos de agosto"))